  ...
  constructor() {
    ...
    subRouter.get(
      ...
      function (req, res, next) {
        ...
        if (req.params.id == "641") next("route");
        // next route skips all middleware calls and skips to the next route handler
        else {
          console.log(
            "This the first middleware call in the first handler for /r/:id"
          );
      ...
      function (req, res, next) {
        console.log(
          "This is the second middleware call in the first handler for /r/:id. It will cancel other route handlers"
        );
    ...
    subRouter.get("/r/:id", function (req, res, next) {
      console.log(
        "This is the first middleware call in the second handler for /r/:id. It is only accessible when id=641"
      );
